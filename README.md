...
A full-stack team workspace for managing shared tasks, chatting in real time, and jumping into live voice or video calls. Built as a portfolio project to show how a modern web app can combine structured task management with real-time collaboration.
